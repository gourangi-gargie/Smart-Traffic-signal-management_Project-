...
class Vehicle(pygame.sprite.Sprite):
    def __init__(self, lane, vehicleClass, direction_number, direction, will_turn):
        ...
        path = "C:/Users/ASUS/OneDrive/Desktop/Traffic management system integrated with drone tech/Adaptive-Traffic-Signal-Timer-main/Code/YOLO/darkflow/images" + direction + "/" + vehicleClass + ".png"
                ...
                if(self.crossed==0 or self.x+self.currentImage.get_rect().width<mid[self.direction]['x']):
                    ...
                    if(self.turned==0):
                        ...
                        if(self.rotateAngle==90):
                            self.turned = 1
                            path = "C:/Users/ASUS/OneDrive/Desktop/Traffic management system integrated with drone tech/Adaptive-Traffic-Signal-Timer-main/Code/YOLO/darkflow/images" + directionNumbers[((self.direction_number+1)%noOfSignals)] + "/" + self.vehicleClass + ".png"
...
class Main:
    ...
    background = pygame.image.load('C:/Users/ASUS/OneDrive/Desktop/Traffic management system integrated with drone tech/Adaptive-Traffic-Signal-Timer-main/Code/YOLO/darkflow/images/Background.png')
    ...
    redSignal = pygame.image.load('C:/Users/ASUS/OneDrive/Desktop/Traffic management system integrated with drone tech/Adaptive-Traffic-Signal-Timer-main/Code/YOLO\darkflow/images/signals/red.png')
    yellowSignal = pygame.image.load('C:/Users/ASUS/OneDrive/Desktop/Traffic management system integrated with drone tech/Adaptive-Traffic-Signal-Timer-main/Code/YOLO\darkflow/images/signals/yellow.png')
    greenSignal = pygame.image.load('C:/Users/ASUS/OneDrive/Desktop/Traffic management system integrated with drone tech/Adaptive-Traffic-Signal-Timer-main/Code/YOLO\darkflow/images/signals/green.png')
